...
function App() {
  ...
  const teamMembers = [
    ...
    { name: "Nicole Johnson ", url: "https://ih1.redbubble.net/image.3244180654.1591/bg,f8f8f8-flat,750x,075,f-pad,750x1000,f8f8f8.jpg" },
  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      ...
      let riskLabel = ""
      if (percentage >= 50) riskLabel = "High Risk"
      else if (percentage >= 10) riskLabel = "Medium Risk"
      else riskLabel = "Low Risk"

      setScanResult({ percentage, riskLabel })
      setLoading(false)
    }, 3000)
  }
